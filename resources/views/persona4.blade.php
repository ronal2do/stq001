...
@section('destaques')
          <section class="sect-posts intro-posts Bolinha Seminario" style="text-align:center;background-color: #fff;">
            <div class="row g-full">
                ...
                <h2 class="Frase">O que<strong class="Frase--strong"> faz</strong> essa ser <strong class="Frase--strong">a melhor </strong> idade? </h2>
...
<div class="row intro" style="padding:30px;">
    ...
    <div class="g-7 cols">
               <h1 style="color:#fff;font-weight:100;letter-spacing: -0.1em;font-size: 3.5em;">somos<span style="font-family: 'Gotham-Book';font-weight:100;">3ªidade</span></h1>
    </div>
