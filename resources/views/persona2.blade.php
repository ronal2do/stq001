...
@section('destaques')
  <section class="sect-posts intro-posts Bolinha Seminario" style="text-align:center;background-color: #fff;">
            <div class="row g-full">
                ...
                <h2 class="Frase"><strong class="Frase--strong">Cidade</strong> que <strong class="Frase--strong">cuida</strong> das<strong class="Frase--strong"> mulheres</strong>.</h2>
            </div>
        </section>
...
<div class="row intro" style="padding:30px;">
    ...
    <div class="g-7 cols">
               <h1 style="color:#fff;font-weight:100;letter-spacing: -0.1em;font-size: 2.5em;">somos<span style="font-family: 'Gotham-Book';font-weight:100;">mulheres</span></h1>
    </div>
