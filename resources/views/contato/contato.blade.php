  ...
  <div class="block-wrap">
    <div class="block-half block-contact sect-dark">
      <div>             
       <h3>Contato</h3>
       <hr class="sep-left">
       <div style="padding: 2em;"><p>Faça seu cadastro e tenha acesso às novidades e às  <br />informações sobre a cidade.</p>Participando da nossa comunidade você também pode deixar sua foto, mensagem ou vídeo mostrando o que faz você ser São Bernardo.</p></div>
